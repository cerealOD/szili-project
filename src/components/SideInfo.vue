<template>
  <div
    class="bg-menu-gray rounded-2xl p-8 flex flex-col lg:ml-8 lg:items-center lg:w-[360px] mb-16 lg:mb-0 lg:sticky lg:top-[156px]"
  >
    ...
    <button
      ...
      @click="downLoadPdf"
    >
      <img :src="'/icons/download.svg'" width="20" class="resume-svg-white" />
      <img
